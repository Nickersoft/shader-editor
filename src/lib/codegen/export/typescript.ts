...
export function generateTypeScript(uniforms: GeneratedUniform[], shaderName: string): string {
 ...
 */
export function computePropNames(uniforms: GeneratedUniform[]): Map<string, string> {
