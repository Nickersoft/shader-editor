import { B as writable, z as readable } from "./chunks/index-server.js";
import {
  _ as text_encoder,
...
import {
  E as PAGE_METHODS,
  a as get_node_type,
  c as has_prerendered_path,
  d as serialize_uses,
  f as static_error_page,
  g as negotiate,
  h as is_form_content_type,
  i as get_global_name,
  l as method_not_allowed,
  m as s,
  o as handle_error_and_jsonify,
  p as escape_html,
  r as format_server_error,
  s as handle_fatal_error,
  t as clarify_devalue_error,
  u as redirect_response,
  w as ENDPOINT_METHODS,
  y as deserialize_binary_form,
...
function is_endpoint_request(event) {
  ...
  return (
    negotiate(event.request.headers.get("accept") ?? "*/*", ["*", "text/html"]) !== "text/html"
  );
}
//#endregion
