...
return {
	...
	_: {
		...
		routes: [
			...
			{
				id: "/r/shader-mount",
				pattern: /^\/r\/shader-mount\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/r/shader-mount/_server.ts.js'))
			}
		],
