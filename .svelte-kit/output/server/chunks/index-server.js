    ...
    for (const batch of batches) {
      ...
      if (others.length === 0) {
        ...
        var current_unequal = [...batch.current.keys()].filter((c) =>
          this.current.has(c) ? this.current.get(c)[0] !== c : true,
        );
...
export {
  ...
  mutable_source as F,
  hydrate_next as G,
  component_context as H,
  set as I,
  set_hydrate_node as J,
  hydrate_node as K,
  boundary as L,
  get_first_child as M,
  get_next_sibling as N,
  without_reactive_context as O,
  init_operations as P,
  state_proxy_unmount as Q,
  flushSync as R,
  get as S,
  component_root as T,
  pop as U,
  ...
  set_hydrating as Y,
  lifecycle_double_unmount as Z,
  stringify as _,
  hasContext as _t,
  unmount as a,
  HYDRATION_ERROR as at,
  active_effect as b,
  attr_style as c,
  REACTION_RAN as ct,
  derived as d,
  define_property as dt,
  rune_outside_svelte as et,
  element as f,
  noop as ft,
  spread_props as g,
  getContext as gt,
  render as h,
  getAllContexts as ht,
  tick as i,
  ATTACHMENT_KEY as it,
  create_text as j,
