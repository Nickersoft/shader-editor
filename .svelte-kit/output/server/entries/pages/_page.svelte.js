...
function zFloat(min, max, step = 0.01) {
  return withMeta(z.number().min(min).max(max), {
    ui: {
      min,
      max,
      step,
...
function zVec2(min, max, step = 0.01) {
  const ui =
...
function transformFields() {
  return {
    x: withMeta(zCenterAxis(1, 0.001).default(0.5).describe("X"), { ui: { group: "transform" } }),
    y: withMeta(zCenterAxis(1, 0.001).default(0.5).describe("Y"), { ui: { group: "transform" } }),
...
var EdgeModeSchema = z.enum(["stretch", "transparent", "mirror", "wrap"]);
function zEdges() {
...
var ImageFitSchema = z.enum(["cover", "contain", "fill"]);
...
var DEFAULT_BACKGROUND = [0, 0, 0, 0];
...
var config$101 = z.object({
  colorA: zColor().default([1, 0.42, 0.21]).describe("Color A"),
  ...
  highlightColor: zColor().default([1, 0.88, 0.1]).describe("Highlight Color"),
...
var config$100 = z.object({
  scale: zFloat(1, 64, 0.5).default(8).describe("Scale"),
...
var config$95 = z.object({
  colorA: zColor().default([0.04, 0, 0.08]).describe("Color A"),
  colorB: zColor().default([0.42, 0.09, 0.9]).describe("Color B"),
  colorC: zColor().default([1, 0.3, 0.42]).describe("Color C"),
  colorD: zColor().default([1, 0.42, 0.21]).describe("Color D"),
...
var config$94 = z.object({
  ...
  colorA: zColor().default([0.1, 1, 0]).describe("Color A"),
  colorB: zColor().default([0, 0, 1]).describe("Color B"),
...
var config$90 = z.object({ tint: zColorRgba().default([1, 1, 1, 1]).describe("Tint") });
...
var config$89 = z.object({
  colorA: zColor().default([0.28, 0.46, 0.9]).describe("Color A"),
  positionA: zCenter().default([0.2, 0.2]).describe("Position A"),
  colorB: zColor().default([0.77, 0.3, 1]).describe("Color B"),
  positionB: zCenter().default([0.8, 0.2]).describe("Position B"),
  colorC: zColor().default([0.1, 0.74, 0.61]).describe("Color C"),
  ...
  colorE: zColor().default([1, 0.55, 0.26]).describe("Color E"),
...
var config$84 = z.object({ color: zColor().default([0.357, 0.094, 0.792]).describe("Color") });
...
var config$67 = z.object({
  ...transformFields(),
  rounding: zFloat(0, 1, 0.001).default(0.2).describe("Rounding"),
  fillColor: zColor().default([1, 1, 1]).describe("Fill"),
  strokeColor: zColor().default([0, 0, 0]).describe("Stroke"),
  strokeWidth: zFloat(0, 0.1, 0.001).default(0).describe("Stroke Width"),
  strokeMode: z.enum(["inside", "center", "outside"]).default("center").describe("Stroke Mode"),
...
var RoundedRect = class extends GeneratorNode {
  ...
  glsl() {
    ...
    const sw = this.uniformName("strokeWidth");
    return {
      dependencies: ["aastep", "sdRoundedBox", "rotate2D"],
      main: `
vec2 _ar = vec2(u_resolution.x / u_resolution.y, 1.0);
vec2 p = (uv - vec2(${x}, ${y})) * _ar;
p = rotate2D(p, ${rot} * 3.14159265 / 180.0);
...
var config$60 = z.object({
  glowIntensity: zFloat(0, 2, 0.05).default(1).describe("Glow Intensity"),
  glowSize: zFloat(0, 1, 0.01).default(0.3).describe("Glow Size"),
  flicker: zFloat(0, 1, 0.01).default(0).describe("Flicker"),
  coreColor: zColor().default([1, 1, 1]).describe("Core Color"),
  glowColor: zColor().default([1, 0.6, 0.2]).describe("Glow Color"),
});
...
var config$59 = z.object({
  ...
  scale: zFloat(0.1, 5, 0.05).default(2).describe("Scale"),
  color1: zColor().default([0.55, 0.95, 1]).describe("Color 1"),
...
var config$56 = z.object({
  ...
  scale: zFloat(0.5, 20, 0.1).default(3).describe("Scale"),
  frequency: zFloat(1, 30, 0.5).default(5).describe("Line Frequency"),
  thickness: zFloat(0, 1).default(0.5).describe("Thickness"),
  softness: zFloat(0, 1).default(0.3).describe("Softness"),
...
var config$51 = z.object({
  ...
  speed: zFloat(0, 30, 0.1).default(6).describe("Speed"),
...
var config$48 = z.object({
  ...
  color: zColor().default([1, 0.9, 0.7]).describe("Color"),
});
...
var config$43 = z.object({
  intensity: zFloat(0, 1).default(0.5).describe("Intensity"),
  speed: zFloat(0, 2, 0.05).default(0.5).describe("Speed"),
  scale: zFloat(0.1, 5, 0.05).default(1).describe("Scale"),
  color1: zColor().default([0, 0.4, 1]).describe("Color 1"),
  color2: zColor().default([0, 1, 0.4]).describe("Color 2"),
  color3: zColor().default([1, 0, 0.4]).describe("Color 3"),
  color4: zColor().default([0.2, 0, 1]).describe("Color 4"),
  color5: zColor().default([1, 1, 0.2]).describe("Color 5"),
});
...
var config$42 = z.object({
  ...
  speed: zFloat(0, 5, 0.05).default(1).describe("Speed"),
  intensity: zFloat(0, 1).default(0.3).describe("Intensity"),
...
var config$41 = z.object({
  ...
  color: zColor().default([1, 0.9, 0.4]).describe("Color"),
  intensity: zFloat(0, 1).default(0.5).describe("Intensity"),
...
var config$40 = z.object({
  ...
  speed: zFloat(0, 2, 0.05).default(0.3).describe("Speed"),
  scale: zFloat(0.1, 5, 0.05).default(1).describe("Scale"),
  color1: zColor().default([1, 1, 1]).describe("Color 1"),
...
var config$39 = z.object({
  ...
  scale: zFloat(1, 30, 0.5).default(4).describe("Scale"),
  speed: zFloat(0, 4, 0.05).default(0.5).describe("Speed"),
...
var config$35 = z.object({
  centerX: zCenterAxis().default(0.5).describe("Center X"),
  centerY: zCenterAxis().default(0.5).describe("Center Y"),
  radius: zFloat(0, 5, 0.05).default(1).describe("Radius"),
  strength: zFloat(-1, 1, 0.05).default(1).describe("Strength"),
...
var config$33 = z.object({
  intensity: zFloat(0, 1, 0.01).default(0.5).describe("Intensity"),
  detail: zFloat(0, 2, 0.05).default(1).describe("Detail"),
...
var config$32 = z.object({
  frequency: zFloat(1, 50, 0.5).default(8).describe("Frequency"),
  softness: zFloat(0, 1, 0.01).default(0.5).describe("Softness"),
  refraction: zFloat(0, 1, 0.01).default(0.5).describe("Refraction"),
  aberration: zFloat(0, 1, 0.01).default(0).describe("Aberration"),
  lightAngle: zAngle().default(45).describe("Light Angle"),
...
var config$31 = z.object({
  centerX: zCenterAxis().default(0.5).describe("Center X"),
  centerY: zCenterAxis().default(0.5).describe("Center Y"),
  pan: zFloat(-90, 90, 0.5).default(0).describe("Pan (deg)"),
  tilt: zFloat(-90, 90, 0.5).default(0).describe("Tilt (deg)"),
...
var config$26 = z.object({
  ...
  intensity: zFloat(0, 1, 0.01).default(1).describe("Intensity"),
  edges: zEdges().default("transparent").describe("Edges"),
});
...
var PolarCoordinates = class extends EffectNode {
  ...
  glsl() {
    ...
    return {
      dependencies: ["applyEdgeHandling", "unpremultiplyAlpha"],
      main: `${
        this.config.mode === "rect-to-polar"
          ? `
float aspect = u_resolution.x / max(u_resolution.y, 1.0);
vec2 aspectUV = vec2(uv.x * aspect, uv.y);
vec2 centerPos = vec2(${cx} * aspect, 1.0 - ${cy});
...
var config$23 = z.object({
  ...
  centerY: zCenterAxis().default(0.5).describe("Center Y"),
  radius: zFloat(0, 1, 0.01).default(0.5).describe("Radius"),
  depth: zFloat(0, 2, 0.01).default(1).describe("Depth"),
  lightAngle: zAngle().default(45).describe("Light Angle"),
...
var config$22 = z.object({
  angle: zAngle().default(0).describe("Angle"),
  strength: zFloat(-1, 1, 0.01).default(0).describe("Strength"),
...
var WaveTypeSchema = z.enum(["sine", "triangle", "square", "sawtooth", "bounce"]);
var config$20 = z.object({
  ...
  frequency: zFloat(0, 50, 0.5).default(5).describe("Frequency"),
  speed: zFloat(0, 5, 0.05).default(1).describe("Speed"),
...
var config$10 = z.object({
  colorA: zColor().default([1, 0, 0]).describe("Color A (shadows)"),
...
var config$4 = z.object({ amount: zFloat(0, 1).default(0.5).describe("Sharpness") });
...
var config$1 = z.object({
  ...
  colorB: zColor().default([0.184, 1, 0]).describe("Color B (midtones)"),
  colorC: zColor().default([1, 1, 0]).describe("Color C (highlights)"),
...
function createDroppable(input) {
  const droppable = createInstance(
    (manager) =>
      new Droppable(Object.assign(Object.assign({}, input), { register: false }), manager),
  );
...
var FIRST_KEYS$2 = [ARROW_DOWN, PAGE_UP, HOME];
var LAST_KEYS$2 = [ARROW_UP, PAGE_DOWN, "End"];
...
var FIRST_KEYS$1 = [ARROW_DOWN, PAGE_UP, HOME];
var LAST_KEYS$1 = [ARROW_UP, PAGE_DOWN, "End"];
...
function getNextMatch(values, search, currentMatch) {
  ...
  if (lowerSearch.endsWith(" ")) {
     ...
     */
    if (values.filter((value) => value.toLowerCase().startsWith(searchWithoutSpace)).length <= 1)
    ...
    if (spacedMatches.length > 0) {
      ...
      return (
        wrapArray(spacedMatches, Math.max(currentMatchIndex, 0)).find(
...
var DOMTypeahead = class {
  ...
  handleTypeaheadSearch(key, candidates) {
    ...
    const nextMatch = getNextMatch(
      candidates.map((item) => item.textContent?.trim() ?? ""),
      this.#search.current,
      currentMatch,
    );
...
var MenuContentState = class MenuContentState {
  ...
  #dispatchPointerMoveToHoveredSubTrigger(pointerPoint) {
    ...
    const hoveredSubTrigger = hoveredNode.closest(
      `[${this.parentMenu.root.getBitsAttr("sub-trigger")}]`,
    );
...
var MenuSubTriggerState = class MenuSubTriggerState {
  static create(opts) {
    ...
    return new MenuSubTriggerState(
      opts,
      new MenuItemSharedState(opts, content),
      content,
      MenuMenuContext.get(),
    );
  }
...
var MenuCheckboxItemState = class MenuCheckboxItemState {
  static create(opts, checkboxGroup) {
    return new MenuCheckboxItemState(
      opts,
      new MenuItemState(opts, new MenuItemSharedState(opts, MenuContentContext.get())),
      checkboxGroup,
    );
  }
  opts;
...
var DataTypeahead = class {
  ...
  handleTypeaheadSearch(key) {
    ...
    const nextMatch = getNextMatch(
      this.#candidateValues().map((item) => item ?? ""),
      this.#search.current,
      currentMatch,
    );
...
var FIRST_KEYS = [ARROW_DOWN, PAGE_UP, HOME];
var LAST_KEYS = [ARROW_UP, PAGE_DOWN, "End"];
...
var SelectRootState = class {
  static create(props) {
    ...
    const rootState =
      type === "single" ? new SelectSingleRootState(rest) : new SelectMultipleRootState(rest);
...
var SelectTriggerState = class SelectTriggerState {
  ...
  onkeydown(e) {
    ...
    if (
      (e.key === "Enter" || (e.key === " " && this.#domTypeahead.search === "")) &&
      !e.isComposing
    ) {
      e.preventDefault();
...
var SelectItemState = class SelectItemState {
  ...
  #props = derived(() => ({
    ...
    "data-disabled": boolToEmptyStrOrUndef(this.opts.disabled.current),
    "data-highlighted":
      this.root.highlightedValue === this.opts.value.current && !this.opts.disabled.current
        ? ""
        : void 0,
      ...
      $$renderer.push("<!--[0-->");
      {
        function popper($$renderer, { props, wrapperProps }) {
          ...
          if (child) {
            ...
            $$renderer.push("<!--[-1-->");
            $$renderer.push(
              `<div${attributes({ ...wrapperProps })}><div${attributes({ ...finalProps })}>`,
            );
            children?.($$renderer);
  ...
  $$renderer.component(($$renderer) => {
    ...
    function isValidEvent(e) {
      if ("button" in e && e.button === 2) {
        ...
        return (
          target.closest(`[${CONTEXT_MENU_TRIGGER_ATTR}]`) !== contentState.parentMenu.triggerNode
        );
      }
      return false;
    }
...
function Scroll_area_viewport($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    $$renderer.push(
      `<div${attributes({ ...mergedProps() })}><div${attributes({ ...mergedContentProps() })}>`,
    );
    children?.($$renderer);
    $$renderer.push(`<!----></div></div>`);
    bind_props($$props, { ref });
...
function Scroll_area_scrollbar_x($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    Scroll_area_scrollbar_shared(
      $$renderer,
      spread_props([derived(() => mergeProps(restProps, scrollbarXState.props))()]),
    );
  });
}
//#endregion
...
function Scroll_area_scrollbar_y($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    Scroll_area_scrollbar_shared(
      $$renderer,
      spread_props([derived(() => mergeProps(restProps, scrollbarYState.props))()]),
    );
  });
}
//#endregion
...
function Scroll_area_scrollbar_visible($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    let { $$slots, $$events, ...restProps } = $$props;
    if (
      ScrollAreaScrollbarVisibleState.create().scrollbar.opts.orientation.current === "horizontal"
    ) {
      $$renderer.push("<!--[0-->");
...
function Scroll_area_thumb_impl($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    const mergedProps = derived(() =>
      mergeProps(restProps, thumbState.props, { style: { hidden: !present } }),
    );
    if (child) {
      $$renderer.push("<!--[0-->");
      child($$renderer, { props: mergedProps() });
...
var SliderRootState = class {
  static create(opts) {
    ...
    const rootState =
      type === "single" ? new SliderSingleRootState(rest) : new SliderMultiRootState(rest);
    return SliderRootContext.set(rootState);
  }
};
var VALID_SLIDER_KEYS = [ARROW_LEFT, ARROW_RIGHT, ARROW_UP, ARROW_DOWN, HOME, "End"];
var SliderRangeState = class SliderRangeState {
  ...
  #rangeStyles = derived(() => {
    if (Array.isArray(this.root.opts.value.current)) {
      ...
      const min = 0;
      const max =
        trackPadding !== void 0 && trackPadding > 0 && currentValue === maxValue
          ? 0
...
function Scene_header($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    $$renderer.push(
      `<button${attr_class(
        "flex items-center gap-2 h-9 w-full rounded-lg pl-3 pr-3 transition-colors",
        void 0,
        {
    ...
    $$renderer.push(
      `<!----> <span class="text-[14px] font-medium text-white">Scene</span></button>`,
    );
  });
}
//#endregion
  ...
  return {
    ...
    attach(node) {
      ...
      return () => {
        var _a, _b;
        if (
          ((_a = sortable.element) === null || _a === void 0 ? void 0 : _a.isConnected) &&
          !((_b = sortable.manager) === null || _b === void 0
            ? void 0
    ...
    attachSource(node) {
      ...
      return () => {
        var _a, _b;
        if (
          ((_a = sortable.source) === null || _a === void 0 ? void 0 : _a.isConnected) &&
          !((_b = sortable.manager) === null || _b === void 0
            ? void 0
            : _b.dragOperation.status.idle)
        )
    ...
    attachTarget(node) {
      ...
      return () => {
        var _a, _b;
        if (
          ((_a = sortable.target) === null || _a === void 0 ? void 0 : _a.isConnected) &&
          !((_b = sortable.manager) === null || _b === void 0
            ? void 0
            : _b.dragOperation.status.idle)
        )
...
function Check($$renderer, $$props) {
  ...
  Icon(
    $$renderer,
    spread_props([{ name: "check" }, props, { iconNode: [["path", { d: "M20 6 9 17l-5-5" }]] }]),
  );
}
//#endregion
        ...
        children: ($$renderer) => {
          if (Context_menu_trigger) {
            ...
            Context_menu_trigger($$renderer, {
              children: ($$renderer) => {
                $$renderer.push(
                  `<div${attr_class(clsx$1(cn("group/row relative flex items-center gap-2 h-9 rounded-lg pr-2 transition-colors", isSelected() ? "bg-[var(--indigo-700)] text-white" : "text-white hover:bg-[var(--surface-hover)]", !layer.enabled && "opacity-60", sortable.isDragging && "opacity-50", isNestTarget() && "ring-2 ring-inset ring-[var(--indigo-600)] bg-[var(--surface-hover)]")))}${attr_style(`padding-left: ${stringify(leftPad())}px;`)}>`,
                );
                if (hasChildren) {
                  $$renderer.push("<!--[0-->");
                  $$renderer.push(
                    `<button class="absolute top-1/2 -translate-y-1/2 p-0.5 text-white/80 hover:text-white"${attr_style(`left: ${stringify(leftPad() - 24)}px;`)}${attr("aria-label", isExpanded ? "Collapse children" : "Expand children")}>`,
                  );
                  if (isExpanded) {
                    $$renderer.push("<!--[0-->");
                ...
                $$renderer.push(
                  `<!--]--></button> <button class="p-1 text-white/70 hover:text-white" aria-label="Remove layer">`,
                );
...
function Sortable_effect_row($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    if (node()) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<div${attr_class(clsx$1(cn("group/row relative flex items-center gap-2 h-9 rounded-lg pr-2 transition-colors", isSelected() ? "bg-[var(--indigo-700)] text-white" : "bg-[var(--surface-strong)] text-white hover:bg-[var(--surface-hover)]", !node().enabled && "opacity-60", sortable.isDragging && "opacity-50")))}${attr_style(`padding-left: ${stringify(leftPad())}px;`)}><span class="size-3 rounded-[3px] shrink-0" aria-hidden="true"${attr_style("", { "background-color": node().meta.color })}></span> <button class="flex-1 min-w-0 text-left text-[14px] font-medium truncate cursor-grab active:cursor-grabbing"${attr("title", node().meta.name)}>${escape_html(node().meta.name)}</button> <div${attr_class("flex items-center gap-0.5 opacity-0 group-hover/row:opacity-100 transition-opacity", void 0, { "opacity-100": isSelected() })}><button class="p-1 text-white/70 hover:text-white" aria-label="Toggle effect">`,
      );
      if (node().enabled) {
        $$renderer.push("<!--[0-->");
        Eye($$renderer, { class: "size-3.5" });
      ...
      $$renderer.push(
        `<!--]--></button> <button class="p-1 text-white/70 hover:text-white" aria-label="Remove effect">`,
      );
      Trash_2($$renderer, { class: "size-3.5" });
      $$renderer.push(`<!----></button></div></div>`);
    } else $$renderer.push("<!--[-1-->");
          ...
          Scroll_area($$renderer, {
            ...
            children: ($$renderer) => {
              ...
              if (displayLayers().length === 0 && displayPostEffects().length === 0) {
                $$renderer.push("<!--[0-->");
                $$renderer.push(
                  `<div class="text-center py-6 text-white/40 text-xs px-3">Use the toolbar below to add a shape or texture.</div>`,
                );
              } else {
                $$renderer.push("<!--[-1-->");
                $$renderer.push(`<!--[-->`);
...
var sdEquilateralTriangle = helper({
  code: `
...
function Draggable_handle($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    $$renderer.push(
      `<circle role="button" tabindex="0" aria-label="Drag handle"${attr("cx", cx)}${attr("cy", cy)}${attr("r", size / 2)}${attr("fill", fill)} stroke="#0a0a0a"${attr("stroke-width", 1.5)}${attr_style(
        "",
        {
          cursor,
          "pointer-events": "auto",
...
function Transform_widget($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    $$renderer.push(
      `<g${attr("transform", groupTransform())}><rect${attr("x", -halfWPx())}${attr("y", -halfHPx())}${attr("width", halfWPx() * 2)}${attr("height", halfHPx() * 2)} fill="none" stroke="rgba(59, 130, 246, 0.6)" stroke-width="1" stroke-dasharray="3 3" vector-effect="non-scaling-stroke"${attr_style("", { "pointer-events": "none" })}></rect><!--[-->`,
    );
    ...
    for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
      ...
      $$renderer.push(
        `<rect role="button" tabindex="-1" aria-label="Rotate"${attr("x", cx - ROTATE_HOT_RADIUS / 2)}${attr("y", cy - ROTATE_HOT_RADIUS / 2)}${attr("width", ROTATE_HOT_RADIUS)}${attr("height", ROTATE_HOT_RADIUS)} fill="transparent"${attr_style(
          "",
          {
    ...
    for (let $$index_1 = 0, $$length = each_array_1.length; $$index_1 < $$length; $$index_1++) {
      ...
      if (edge.axis === "x") {
        $$renderer.push("<!--[0-->");
        $$renderer.push(
          `<rect role="button" tabindex="-1" aria-label="Resize"${attr("x", edge.sign * halfWPx() - EDGE_THICKNESS / 2)}${attr("y", -halfHPx())}${attr("width", EDGE_THICKNESS)}${attr("height", halfHPx() * 2)} fill="transparent"${attr_style(
            "",
            {
              cursor: edge.cursor,
              "pointer-events": "auto",
        ...
        $$renderer.push("<!--[-1-->");
        $$renderer.push(
          `<rect role="button" tabindex="-1" aria-label="Resize"${attr("x", -halfWPx())}${attr("y", edge.sign * halfHPx() - EDGE_THICKNESS / 2)}${attr("width", halfWPx() * 2)}${attr("height", EDGE_THICKNESS)} fill="transparent"${attr_style(
            "",
            {
              cursor: edge.cursor,
              "pointer-events": "auto",
    ...
    for (let $$index_2 = 0, $$length = each_array_2.length; $$index_2 < $$length; $$index_2++) {
      ...
      $$renderer.push(
        `<rect role="button" tabindex="-1" aria-label="Resize corner"${attr("x", corner.sx * halfWPx() - HANDLE_SIZE / 2)}${attr("y", corner.sy * halfHPx() - HANDLE_SIZE / 2)}${attr("width", HANDLE_SIZE)}${attr("height", HANDLE_SIZE)} fill="#22d3ee" stroke="#0a0a0a" stroke-width="1.5" vector-effect="non-scaling-stroke"${attr_style(
          "",
          {
...
function Canvas_overlay($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    function applyBoundingBoxDrag(c, px, py, uniformModifier) {
      const cxVal = config()[c.cx] ?? 0.5;
      const cyVal = config()[c.cy] ?? 0.5;
    ...
    if (layer && width > 0 && height > 0 && controls().length > 0) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<svg class="absolute inset-0 pointer-events-none"${attr("width", width)}${attr("height", height)}${attr("viewBox", `0 0 ${width} ${height}`)} preserveAspectRatio="none"><!--[-->`,
      );
      ...
      for (let idx = 0, $$length = each_array.length; idx < $$length; idx++) {
        ...
        if (c.kind === "point") {
          ...
          Draggable_handle($$renderer, {
            cx: toPx(config()[c.x] ?? 0.5, width),
            cy: toPxY(config()[c.y] ?? 0.5, height),
            fill: "#3b82f6",
            onDrag: (px, py) => {
              setFields({
                [c.x]: fromPx(px, width),
          ...
          $$renderer.push("<!--[1-->");
          const cx = toPx(config()[c.cx] ?? 0.5, width);
          const cy = toPxY(config()[c.cy] ?? 0.5, height);
          const r = radiusToPx(config()[c.r] ?? 0.3, width, height);
          $$renderer.push(
            `<g><circle${attr("cx", cx)}${attr("cy", cy)}${attr("r", r)} fill="none" stroke="rgba(59, 130, 246, 0.5)"${attr("stroke-width", 1)} stroke-dasharray="3 3"${attr_style("", { "pointer-events": "none" })}></circle>`,
          );
          Draggable_handle($$renderer, {
            cx: cx + r,
            cy,
          ...
          Transform_widget($$renderer, {
            x: config()[c.x] ?? 0.5,
            y: config()[c.y] ?? 0.5,
            width: config()[c.w] ?? 0.5,
            height: config()[c.h] ?? 0.5,
          ...
          const halfMul = c.halfExtent ? 1 : 0.5;
          const base = height;
          const halfW = ext ? ext.w * base : (config()[c.w] ?? 0.5) * halfMul * base;
          const halfH = ext ? ext.h * base : (config()[c.h] ?? 0.5) * halfMul * base;
          $$renderer.push(
            `<g><rect${attr("x", cx - halfW)}${attr("y", cy - halfH)}${attr("width", halfW * 2)}${attr("height", halfH * 2)} fill="none" stroke="rgba(59, 130, 246, 0.5)"${attr("stroke-width", 1)} stroke-dasharray="3 3"${attr_style("", { "pointer-events": "none" })}></rect><!--[-->`,
          );
          ...
          $$renderer.push(
            `<g><line${attr("x1", x1)}${attr("y1", y1)}${attr("x2", x2)}${attr("y2", y2)} stroke="rgba(59, 130, 246, 0.6)"${attr("stroke-width", 1.5)} stroke-dasharray="4 3"${attr_style("", { "pointer-events": "none" })}></line>`,
          );
          Draggable_handle($$renderer, {
            cx: x1,
            cy: y1,
          ...
          for (let pi = 0, $$length = each_array_2.length; pi < $$length; pi++) {
            ...
            Draggable_handle($$renderer, {
              cx: toPx(config()[xKey] ?? 0.5, width),
              cy: toPxY(config()[yKey] ?? 0.5, height),
              fill: "#3b82f6",
              onDrag: (nx, ny) => {
                setFields({
          ...
          $$renderer.push("<!--[7-->");
          const v = config()[c.center] ?? [0.5, 0.5];
          ...
          $$renderer.push("<!--[8-->");
          const a = config()[c.from] ?? [0, 0.5];
          const b = config()[c.to] ?? [1, 0.5];
          ...
          $$renderer.push("<!--[9-->");
          const cx = toPx(config()[c.x] ?? 0.5, width);
          const cy = toPxY(config()[c.y] ?? 0.5, height);
...
function Shader_preview($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    $$renderer.push(
      `<div class="relative w-full h-full transparency-checker svelte-1a1gil9"><canvas class="w-full h-full"></canvas> `,
    );
    ...
    function $$render_inner($$renderer) {
      {
        function children($$renderer, { thumbItems }) {
          $$renderer.push(
            `<span data-slot="slider-track"${attr("data-orientation", orientation)}${attr_class(clsx$1(cn("bg-muted rounded-full data-horizontal:h-1 data-horizontal:w-full data-vertical:h-full data-vertical:w-1 bg-muted relative grow overflow-hidden data-horizontal:w-full data-vertical:h-full")))}>`,
          );
          if (Slider_range) {
            $$renderer.push("<!--[-->");
...
function Color_input($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    $$renderer.push(
      `<div class="space-y-2"><div class="flex items-center gap-2"><input type="color"${attr("value", hexValue())} class="w-8 h-8 rounded border border-border cursor-pointer"/> <span class="text-xs text-muted-foreground font-mono">${escape_html(hexValue())} `,
    );
    if (hasAlpha()) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<span class="opacity-60">${escape_html(Math.round(value[3] * 100))}%</span>`,
      );
    } else $$renderer.push("<!--[-1-->");
    ...
    if (hasAlpha()) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<div class="flex items-center gap-2"><span class="text-[10px] text-muted-foreground w-4">A</span> `,
      );
      Slider($$renderer, {
        type: "single",
        value: value[3],
...
function Color_array_input($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    for (let i = 0, $$length = each_array.length; i < $$length; i++) {
      ...
      $$renderer.push(
        `<div class="flex items-center gap-2"><input type="color"${attr("value", hex)} class="w-7 h-7 rounded border border-border cursor-pointer"/> <span class="text-[11px] font-mono text-muted-foreground flex-1">${escape_html(hex)}</span> `,
      );
      Slider($$renderer, {
        type: "single",
        value: c[3] ?? 1,
      ...
      if (colors().length > minLength) {
        $$renderer.push("<!--[0-->");
        $$renderer.push(
          `<button class="text-muted-foreground hover:text-destructive p-0.5" aria-label="Remove color">`,
        );
    ...
    if (colors().length < maxLength) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<button class="flex items-center gap-1 text-[11px] text-muted-foreground hover:text-foreground py-1">`,
      );
...
function Image_input($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    let { value, onChange } = $$props;
    $$renderer.push(
      `<div class="space-y-2"><div class="flex items-center gap-2 p-2 rounded border border-dashed border-border bg-muted/30 cursor-pointer hover:bg-muted/50" role="button" tabindex="0">`,
    );
    if (value.url) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<img${attr("src", value.url)} alt="Preview" class="w-12 h-12 object-cover rounded"/>`,
      );
    } else {
      $$renderer.push("<!--[-1-->");
      $$renderer.push(
    ...
    $$renderer.push(
      `<!--]--> <div class="flex-1 min-w-0"><div class="text-[11px] text-muted-foreground truncate">${escape_html(value.url ? (value.sourceKind === "dataUrl" ? "Uploaded file" : value.url) : "Drop or paste an image")}</div> `,
    );
    $$renderer.push("<!--[-1-->");
    $$renderer.push(`<!--]--></div> `);
    if (value.url) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<button class="text-muted-foreground hover:text-destructive p-1" aria-label="Clear image">`,
      );
      X($$renderer, { class: "h-3 w-3" });
      $$renderer.push(`<!----></button>`);
    } else $$renderer.push("<!--[-1-->");
    $$renderer.push(
      `<!--]--></div> <input type="file" accept="image/*" class="hidden"/> <input type="text" placeholder="…or paste a URL" class="w-full h-7 text-[11px] px-2 rounded border border-border bg-background"/> <div class="grid grid-cols-2 gap-2"><label class="text-[10px] text-muted-foreground">Fit `,
    );
    $$renderer.select(
      {
...
function Field_control($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    if (field.glslType === "enumString") {
          ...
          children: ($$renderer) => {
            if (Select_trigger) {
              ...
              Select_trigger($$renderer, {
                ...
                children: ($$renderer) => {
                  $$renderer.push(
                    `<!---->${escape_html(current.charAt(0).toUpperCase() + current.slice(1))}`,
                  );
                },
                $$slots: { default: true },
              });
                  ...
                  for (
                    ...
                    if (Select_item) {
                      ...
                      Select_item($$renderer, {
                        ...
                        children: ($$renderer) => {
                          $$renderer.push(
                            `<!---->${escape_html(opt.charAt(0).toUpperCase() + opt.slice(1))}`,
                          );
                        },
                        $$slots: { default: true },
                      });
      ...
      $$renderer.push(
        `<!----> <span class="text-xs text-muted-foreground font-mono w-12 text-right">${escape_html(numValue.toFixed(2))}</span></div> `,
      );
      Slider($$renderer, {
        type: "single",
        value: numValue,
      ...
      $$renderer.push(
        `<!----> <span class="text-xs text-muted-foreground font-mono w-12 text-right">${escape_html(intValue)}</span></div> `,
      );
      Slider($$renderer, {
        type: "single",
        value: intValue,
      ...
      $$renderer.push(
        `<!----> <input type="checkbox"${attr("checked", Boolean(value), true)}/></div>`,
      );
      ...
      $$renderer.push(
        `<!----> <div class="space-y-2"><div class="flex items-center gap-2"><span class="text-xs text-muted-foreground w-4">X</span> `,
      );
      Slider($$renderer, {
        type: "single",
        value: vec2Value[0],
      ...
      $$renderer.push(
        `<!----> <span class="text-xs text-muted-foreground font-mono w-10 text-right">${escape_html(vec2Value[0].toFixed(2))}</span></div> <div class="flex items-center gap-2"><span class="text-xs text-muted-foreground w-4">Y</span> `,
      );
      Slider($$renderer, {
        type: "single",
        value: vec2Value[1],
      ...
      $$renderer.push(
        `<!----> <span class="text-xs text-muted-foreground font-mono w-10 text-right">${escape_html(vec2Value[1].toFixed(2))}</span></div></div></div>`,
      );
      ...
      if (ui()?.color || vecValue.every((v) => v >= 0 && v <= 1)) {
        ...
        for (let i = 0, $$length = each_array_1.length; i < $$length; i++) {
          ...
          $$renderer.push(
            `<div class="flex items-center gap-2"><span class="text-xs text-muted-foreground w-4">${escape_html(
              ["X", "Y", "Z", "W"][i],
            )}</span> `,
          );
          Slider($$renderer, {
...
function Layer_effects_sections($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    for (let $$index_2 = 0, $$length = each_array.length; $$index_2 < $$length; $$index_2++) {
      ...
      $$renderer.push(
        `<section class="px-3 py-3 space-y-3 border-b border-[rgba(255,255,255,0.1)] last:border-b-0"><div class="flex items-center justify-between px-1"><p class="text-[14px] font-medium text-white">${escape_html(section.label)}</p> `,
      );
      if (options.length > 0) {
        $$renderer.push("<!--[0-->");
        if (Select) {
      ...
      if (items.length === 0) {
        $$renderer.push("<!--[0-->");
        $$renderer.push(
          `<p class="px-1 text-[12px] text-white/40">${escape_html(options.length === 0 ? `No ${section.label.toLowerCase()} apply to this layer.` : `No ${section.label.toLowerCase()} added.`)}</p>`,
        );
      } else {
        $$renderer.push("<!--[-1-->");
        $$renderer.push(`<div class="space-y-1"><!--[-->`);
...
function Property_panel($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    let blendModeLabel = derived(
      () =>
        BLEND_MODES.find((m) => m.value === (selectedNode()?.blendMode ?? "normal"))?.label ??
        "Normal",
    );
    if (!selectedNode() || !fields()) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<div class="flex items-center justify-center h-full text-white/50 text-sm px-6 text-center">Select a layer to edit its properties.</div>`,
      );
    } else {
      $$renderer.push("<!--[-1-->");
      ...
      Scroll_area($$renderer, {
        ...
        children: ($$renderer) => {
          $$renderer.push(
            `<div class="py-3"><section class="px-3 py-3 space-y-3 border-b border-[rgba(255,255,255,0.1)]"><div class="px-1"><p class="text-[12px] font-medium text-white">Blending</p></div> `,
          );
          if (Select) {
            $$renderer.push("<!--[-->");
            Select($$renderer, {
          ...
          $$renderer.push(
            `</section> <section class="px-3 py-3 space-y-3 border-b border-[rgba(255,255,255,0.1)]"><div class="flex items-center justify-between px-1"><p class="text-[12px] font-medium text-white">Opacity</p> <span class="text-[12px] text-white/60 font-mono">${escape_html(Math.round(selectedNode().opacity * 100))}%</span></div> `,
          );
          Slider($$renderer, {
            type: "single",
          ...
          if (allFieldsCount > 0) {
            ...
            for (
              ...
              $$renderer.push(
                `<section class="px-3 py-3 space-y-4 border-b border-[rgba(255,255,255,0.1)] last:border-b-0"><div class="px-1"><p class="text-[14px] font-medium text-white">${escape_html(section.label)}</p></div> <!--[-->`,
              );
              const each_array_2 = ensure_array_like(section.fields);
              for (
                let $$index_1 = 0, $$length = each_array_2.length;
                $$index_1 < $$length;
                $$index_1++
              ) {
            ...
            if (groupedFields().every((s) => s.key !== "") && fields().inFields.length > 0) {
              $$renderer.push("<!--[0-->");
              $$renderer.push(
                `<section class="px-3 py-3 space-y-4 border-b border-[rgba(255,255,255,0.1)]"><div class="px-1"><p class="text-[14px] font-medium text-white">Inputs</p></div> <!--[-->`,
              );
...
function Canvas_toolbar($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    $$renderer.push(
      `<div class="absolute bottom-4 left-1/2 -translate-x-1/2 glass-floating rounded-full flex items-center gap-2 px-4 py-3"><!--[-->`,
    );
...
function Effects_palette($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    if (items().length === 0) {
      $$renderer.push("<!--[0-->");
      $$renderer.push(
        `<div class="col-span-4 text-center text-white/50 text-xs py-6">No primitives in this category yet.</div>`,
      );
    } else $$renderer.push("<!--[-1-->");
    $$renderer.push(`<!--]--></div></div>`);
  });
                      ...
                      if (showCloseButton) {
                        ...
                        if (Dialog_close) {
                          ...
                          Dialog_close($$renderer, {
                            ...
                            class:
                              "ring-offset-background focus:ring-ring data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute top-4 right-4 rounded-md opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-hidden disabled:pointer-events-none",
                            children: ($$renderer) => {
                              X($$renderer, { class: "size-4" });
...
function Code_block($$renderer, $$props) {
  $$renderer.component(($$renderer) => {
    ...
    if (!code) {
      ...
      $$renderer.push(
        `<!----> <div class="shiki-wrap text-xs svelte-13i9lgm">${html(html$1)}</div></div>`,
      );
    }
    $$renderer.push(`<!--]-->`);
  });
          ...
          children: ($$renderer) => {
            if (Dialog_content) {
              ...
              Dialog_content($$renderer, {
                class:
                  "max-w-[min(95vw,1100px)] sm:max-w-[min(95vw,1100px)] h-[min(85vh,800px)] p-0 gap-0 flex flex-col overflow-hidden",
                children: ($$renderer) => {
                  if (Dialog_header) {
                    $$renderer.push("<!--[-->");
                  ...
                  if (enabledCount() === 0) {
                    $$renderer.push("<!--[0-->");
                    $$renderer.push(
                      `<div class="flex-1 flex items-center justify-center text-muted-foreground text-sm">Add layers to generate code</div>`,
                    );
                  } else {
                    $$renderer.push("<!--[-1-->");
                    if (Tabs) {
...
function Shader_editor($$renderer) {
  ...
  function $$render_inner($$renderer) {
    ...
    $$renderer.push(
      `<!----></main> <aside class="glass-panel rounded-3xl overflow-hidden min-h-0">`,
    );
