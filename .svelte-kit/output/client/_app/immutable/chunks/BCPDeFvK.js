import { G as e, K as t, ct as n, ft as r, i, n as a, ot as o, q as s } from "./DjA5qdfU.js";
var c = class {
    constructor(e, t) {
      ((this.status = e),
        typeof t == `string`
...
var v = window.fetch;
window.fetch = (e, t) => (
  (e instanceof Request ? e.method : t?.method || `GET`) !== `GET` && y.delete(x(e)),
  v(e, t)
);
var y = new Map();
function ee(e, t) {
                ...
                return (
                  ...
                  i
                    .map((e, n) => {
                      if (n % 2) {
                        if (e.startsWith(`x+`))
                          return ie(String.fromCharCode(parseInt(e.slice(2), 16)));
                        if (e.startsWith(`u+`))
                          return ie(
                            String.fromCharCode(
                              ...e
...
function ne(e) {
  return e.slice(1).split(`/`).filter(C);
}
function re(e, t, n) {
  let r = {},
    i = e.slice(1),
...
var w = globalThis.__sveltekit_c3u4t8?.base ?? ``,
  ce = globalThis.__sveltekit_c3u4t8?.assets ?? w ?? ``,
  le = `1778423232699`,
...
function ve(e, t, n) {
  ...
  let i = e instanceof SVGAElement ? e.target.baseVal : e.target,
    a = !r || !!i || j(r, t, n) || (e.getAttribute(`rel`) || ``).split(/\s+/).includes(`external`),
...
function A(e) {
  ...
  for (; s && s !== document.documentElement; )
    (r === null && (r = k(s, `preload-code`)),
      i === null && (i = k(s, `preload-data`)),
      t === null && (t = k(s, `keepfocus`)),
      n === null && (n = k(s, `noscroll`)),
      a === null && (a = k(s, `reload`)),
      o === null && (o = k(s, `replacestate`)),
      (s = ge(s)));
  function c(e) {
    switch (e) {
      case ``:
...
var N,
  P,
  F,
  Oe = i.toString().includes(`$$`) || /function \w+\(\) \{\}/.test(i.toString()),
  ke = `a:`;
Oe
  ? ((N = {
      data: {},
...
var { onMount: je, tick: Me } = a,
  ...
  I = null,
  L = oe(`sveltekit:scroll`) ?? {},
  R = oe(`sveltekit:snapshot`) ?? {},
  z = { url: ye({}), page: ye({}), navigating: r(null), updated: xe() };
function Pe(e) {
  L[e] = O();
}
function Fe(e, t) {
  let n = e + 1;
  for (; L[n]; ) (delete L[n], (n += 1));
  for (n = t + 1; R[n]; ) (delete R[n], (n += 1));
}
function B(e, t = !1) {
...
async function tt(e, t, n) {
  (globalThis.__sveltekit_c3u4t8 &&
    (globalThis.__sveltekit_c3u4t8.query, globalThis.__sveltekit_c3u4t8.prerender),
  ...
  (n
    ...
    : (await Q({
        type: `enter`,
        url: me(U.hash ? Ft(new URL(location.href)) : location.href),
        replace_state: !0,
      }),
      i()),
    Ot());
...
function rt(e) {
  Ve.some((e) => e?.snapshot) && (R[e] = Ve.map((e) => e?.snapshot?.capture()));
}
function it(e) {
  R[e]?.forEach((e, t) => {
  ...
  (t.invalidateAll && He(),
    await Q({
      ...
      accept: () => {
        if (t.invalidateAll) {
          ((Xe = !0), (i = new Set()));
          for (let [e, t] of $e) for (let n of t.keys()) i.add(M(e, n));
          a = new Set();
          for (let [e, t] of et) for (let n of t.keys()) a.add(M(e, n));
        }
        t.invalidate && t.invalidate.forEach(Dt);
      },
    }),
    t.invalidateAll &&
      s()
        .then(s)
        .then(() => {
          for (let [e, t] of $e) for (let [n, { resource: r }] of t) i?.has(M(e, n)) && r.refresh();
          for (let [e, t] of et)
            for (let [n, { resource: r }] of t) a?.has(M(e, n)) && r.reconnect();
        }));
}
async function st(e) {
  if (e.id !== W?.id) {
    ...
    (Qe.add(t),
      (W = {
        id: e.id,
        token: t,
        promise: _t({ ...e, preload: t }).then(
          (e) => (Qe.delete(t), e.type === `loaded` && e.state.error && He(), e),
        ),
        fork: null,
      }));
  }
...
async function lt(e, t, n) {
  ...
  if (
    (i && i.remove(),
    Object.assign(N, e.props.page),
    (Ze = new U.root({
      target: t,
      props: { ...e.props, stores: z, components: Ve },
      hydrate: n,
      sync: !1,
...
async function ut({
  ...
  let l = {
    ...
    props: { constructors: Te(n).map((e) => e.node.component), page: Pt(N) },
  };
  ...
  return (
    (!K.url || e.href !== K.url.href || K.error !== a || (s !== void 0 && s !== N.form) || f) &&
      (l.props.page = {
        error: a,
        params: t,
        route: { id: o?.id ?? null },
    ...
    if (d[e])
      try {
        ...
        if ((void 0)?.includes(t)) ((s = t.status ?? s), (u = t.error));
          ...
          if (await z.updated.check()) return (await Ie(), await B(n));
  ...
  try {
    return ut({
      ...
      branch: [
        ...
        { node: await V(), loader: V, universal: null, server: null, data: null },
      ],
      status: e,
      error: t,
      errors: [],
...
async function bt(e) {
  ...
  try {
    let r = (async () => {
      let t =
        (await U.hooks.reroute({ url: new URL(e), fetch: async (t, n) => ft(t, n, e).promise })) ??
        e;
      if (typeof t == `string`) {
        let n = new URL(e);
...
function St(e) {
  return (
    f(U.hash ? e.hash.replace(/^#/, ``).replace(/[?#].+/, ``) : e.pathname.slice(w.length)) || `/`
  );
}
function Ct(e) {
...
async function Q({
  ...
  let _ = await xt(n, !1),
    v =
      e === `enter`
        ? Nt(K, _, n, e)
        : wt({ url: n, type: e, delta: r?.delta, intent: _, scroll: r?.scroll, event: m });
  if (!v) {
    (p(), Z === d && (Z = g));
    return;
  }
  ...
  (f(),
    (q = !0),
    qe && v.navigation.type !== `enter` && z.navigating.set((P.current = v.navigation)));
  let b = _ && (await _t(_));
  if (!b) {
    if (j(n, w, U.hash)) return await B(n, o);
    b = await Tt(
      n,
      { id: null },
      await $(new u(404, `Not Found`, `Not found: ${n.pathname}`), {
        url: n,
        params: {},
        route: { id: null },
      }),
  ...
  if (((n = _?.url || n), Z !== d)) return (v.reject(Error(`navigation aborted`)), !1);
  if (b.type === `redirect`) {
    if (l < 20) {
      (await Q({
        type: e,
        url: new URL(b.location, n),
        popped: r,
        keepfocus: i,
        noscroll: a,
        replace_state: o,
    ...
    b = await yt({
      status: 500,
      error: await $(Error(`Redirect loop`), { url: n, params: {}, route: { id: null } }),
      url: n,
      route: { id: null },
    });
  } else b.props.page.status >= 400 && (await z.updated.check()) && (await Ie(), await B(n, o));
  if (
    (nt(),
    Pe(y),
    rt(ee),
    b.props.page.url.pathname !== n.pathname && (n.pathname = b.props.page.url.pathname),
    (c = r ? r.state : c),
    !r)
  ) {
    let e = +!o,
      t = { [T]: (Y += e), [E]: (X += e), [fe]: c };
    ((o ? history.replaceState : history.pushState).call(history, t, ``, n), o || Fe(Y, X));
  }
  let x = _ && W?.id === _.id ? W.fork : null;
  (W?.fork && !x && He(), (W = null), (b.props.page.state = c));
  let S;
  if (qe) {
    let e = (await Promise.all(Array.from(Ge, (e) => e(v.navigation)))).filter(
      (e) => typeof e == `function`,
    );
    if (e.length > 0) {
      function t() {
    ...
    ((K = { ...b.state, nav: { params: r.params, route: r.route, url: r.url } }),
      b.props.page && (b.props.page.url = n));
    let i = x && (await x);
    (i
      ? (S = i.commit())
      : ((I = null),
        Ze.$set(b.props),
        I && Object.assign(b.props.page, I),
        Ae(b.props.page),
        (S = t?.())),
      (Ye = !0));
  ...
  let C = null;
  if (Je) {
    let e = r ? r.scroll : a ? O() : null;
    e
      ? scrollTo(e.x, e.y)
      : (C = n.hash && document.getElementById(It(n)))
        ? C.scrollIntoView()
        : scrollTo(0, 0);
  }
  ...
  (!i && !ne && Mt(n, !C),
    (Je = !0),
    b.props.page && (I && Object.assign(b.props.page, I), Object.assign(N, b.props.page)),
    (q = !1),
    e === `popstate` && it(X),
    v.fulfil(void 0),
    v.navigation.to && (v.navigation.to.scroll = O()),
    G.forEach((e) => e(v.navigation)),
    z.navigating.set((P.current = null)));
}
async function Tt(e, t, n, r, i) {
  return e.origin === pe && e.pathname === location.pathname && !Ke
...
function Et() {
  ...
  function o() {
    ...
    for (let e of H.querySelectorAll(`a`)) {
      ...
      let a = A(e);
      a.reload ||
        (a.preload_code === D.viewport && i.observe(e), a.preload_code === D.eager && ct(t));
    }
  }
  (G.add(o), o());
}
...
function Ot() {
  ((history.scrollRestoration = `manual`),
    ...
    navigator.connection?.saveData || Et(),
    ...
    addEventListener(`popstate`, async (t) => {
      if (!jt)
        if (t.state?.[`sveltekit:history`]) {
          ...
          if (o === X && (Ye || s)) {
            (i !== N.state && (N.state = i), e(a), (L[Y] = O()), r && scrollTo(r.x, r.y), (Y = n));
            return;
          }
          let c = n - Y;
          await Q({
    ...
    addEventListener(`hashchange`, () => {
      J &&
        ((J = !1), history.replaceState({ ...history.state, [T]: ++Y, [E]: X }, ``, location.href));
    }));
  for (let e of document.querySelectorAll(`link`)) Ne.has(e.rel) && (e.href = e.href);
  addEventListener(`pageshow`, (e) => {
    e.persisted && z.navigating.set((P.current = null));
  });
  function e(e) {
    ((K.url = N.url = e), z.page.set(Pt(N)), z.page.notify());
  }
}
async function kt(
  e,
  ...
  let u = new URL(location.href),
    d;
  (({ params: i = {}, route: a = { id: null } } = (await xt(u, !1)) || {}),
    (d = Le.find(({ id: e }) => e === a.id)));
  let f,
    p = !0;
  try {
    ...
    if (t instanceof l) {
      await B(new URL(t.location, location.href));
      return;
    }
    ((f = await yt({
      status: Ee(t),
...
function Nt(e, t, n, r, i = null) {
  ...
  return (
    ...
    {
      navigation: {
        from: { params: e.params, route: { id: e.route?.id ?? null }, url: e.url, scroll: O() },
        to: n && {
...
export { F as a, N as i, z as n, Se as o, P as r, tt as t };
